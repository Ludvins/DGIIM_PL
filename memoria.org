...
Las sentencias pueden ser un bloque, una expresión o las instrucciones de
control (/si/, /otro/, /mientras/, /casos/). Las instrucciones de control
contienen una expresion y una sentencia, y su sintaxis es la misma que la de C.
Notamos que los casos en el /switch/ solo pueden ser números enteros.
