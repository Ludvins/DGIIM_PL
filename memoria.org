...
En nuestro lenguaje implementaremos los *arrays 1D y 2D* como estructura de datos, que solo pueden tener elementos *del mimso* tipo básico en su interior: entero, carácter, real y booleano. Este tipo de datos tendrán las siguientes operaciones:
